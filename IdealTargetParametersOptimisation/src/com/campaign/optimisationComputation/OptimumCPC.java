				...
				for (String campId : campIds) {
					...
					for (ParameterCPCDTO dto1 : dtoList) {
						if (dto1.getCampaignId().equals(campId)) {
							...
							if (dto1.getSpent().equals("0") == false
					...
					if (cpcList.isEmpty() == false) {
						...
						if (m == 1 && n == 0)
							InsertOptimisedParametersData.OSCPCoptimisation(
									campId, "DBM", parameterP1Map
											+ parameterP2Map);
						...
						if (m == 2 && n == 0) {
							...
							InsertOptimisedParametersData
									.SegmentCPCoptimisation(campId, "DBM",
						...
						if (m == 2 && n == 1)
							InsertOptimisedParametersData
									.SegmentCPCoptimisation(campId, "Adwords",
											parameterP1Map + parameterP2Map);

						if (m == 2 && n == 2)
							InsertOptimisedParametersData
									.SegmentCPCoptimisation(campId, "Facebook",
											parameterP1Map + parameterP2Map);

						if (m == 3 && n == 0)
							InsertOptimisedParametersData.AgeCPCoptimisation(
									campId, "DBM", parameterP1Map
											+ parameterP2Map);
						...
						if (m == 4 && n == 0)
							InsertOptimisedParametersData
									.GenderCPCoptimisation(campId, "DBM",
											parameterP1Map + parameterP2Map);

						if (m == 4 && n == 1)
							InsertOptimisedParametersData
									.GenderCPCoptimisation(campId, "Adwords",
											parameterP1Map + parameterP2Map);

						if (m == 4 && n == 2)
							InsertOptimisedParametersData
									.GenderCPCoptimisation(campId, "Facebook",
											parameterP1Map + parameterP2Map);
