...
public class OptimumConvRate1 {
	...
	public static Pattern specialPattern = Pattern
			...
			for (int n = 0; n < 3; n++) {
				...
				for (String campId : campIds) {
					...
					for (ParameterConvRateDTO dto1 : dtoList) {
						if (dto1.getCampaignId().equals(campId)) {
							...
							if (dto1.getConversions().equals("0") == false) {
								...
								convrate = Double.parseDouble(dto1
										.getConversions());

								if (m == 2 && n == 0) {
									parsedKey = StringSimplifier
											.simplifiedString(dto1
													.getParameter());
									...
									if (optimumKey.length > 2)
										convratemap
												.put(optimumKey[optimumKey.length - 2],
														convrate);
								}
					...
					if (convrateList.isEmpty() == false) {
						 ...
						 * else { IstQuartile = ctrList.get((int) integercheck)
						...
						for (Entry<String, Double> entry : convratemap
								.entrySet()) {
						...
						if (m == 0 && n == 0)
							InsertOptimisedParametersData
									.cityConvRateoptimisation(campId, "DBM",
											parameterP1Map + parameterP2Map);

						if (m == 0 && n == 1)
							InsertOptimisedParametersData
									.cityConvRateoptimisation(campId,
											"Adwords", parameterP1Map
													+ parameterP2Map);

						if (m == 0 && n == 2)
							InsertOptimisedParametersData
									.cityConvRateoptimisation(campId,
											"Facebook", parameterP1Map
													+ parameterP2Map);

						if (m == 1 && n == 0)
							InsertOptimisedParametersData
									.OSConvRateoptimisation(campId, "DBM",
											parameterP1Map + parameterP2Map);

						if (m == 1 && n == 1)
							InsertOptimisedParametersData
									.OSConvRateoptimisation(campId, "Adwords",
											parameterP1Map + parameterP2Map);

						if (m == 1 && n == 2)
							InsertOptimisedParametersData
									.OSConvRateoptimisation(campId, "Facebook",
											parameterP1Map + parameterP2Map);
						...
						if (m == 2 && n == 0) {
							...
							InsertOptimisedParametersData
									.SegmentConvRateoptimisation(campId, "DBM",
											parameterP1Map + parameterP2Map);
						...
						if (m == 2 && n == 1)
							InsertOptimisedParametersData
									.SegmentConvRateoptimisation(campId,
											"Adwords", parameterP1Map
													+ parameterP2Map);
						...
						if (m == 3 && n == 0)
							InsertOptimisedParametersData
									.AgeConvRateoptimisation(campId, "DBM",
											parameterP1Map + parameterP2Map);

						if (m == 3 && n == 1)
							InsertOptimisedParametersData
									.AgeConvRateoptimisation(campId, "Adwords",
											parameterP1Map + parameterP2Map);

						if (m == 3 && n == 2)
							InsertOptimisedParametersData
									.AgeConvRateoptimisation(campId,
											"Facebook", parameterP1Map
													+ parameterP2Map);

						if (m == 4 && n == 0)
							InsertOptimisedParametersData
									.GenderConvRateoptimisation(campId, "DBM",
											parameterP1Map + parameterP2Map);

						if (m == 4 && n == 1)
							InsertOptimisedParametersData
									.GenderConvRateoptimisation(campId,
											"Adwords", parameterP1Map
													+ parameterP2Map);
