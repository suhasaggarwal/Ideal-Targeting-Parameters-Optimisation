				...
				for (String campId : campIds) {
					...
					for (ParameterCTRDTO dto1 : dtoList) {
						if (dto1.getCampaignId().equals(campId)) {
							...
							if (dto1.getImpressions().equals("0") == false
									&& dto1.getClicks().equals("0") == false) {

								ctr = Double.parseDouble(dto1.getClicks())
										/ Double.parseDouble(dto1
												.getImpressions());
								...
								if (m == 2 && n == 0) {
									...
									if (optimumKey.length > 2)
										ctrmap.put(
												optimumKey[optimumKey.length - 2],
												ctr);
								}
					...
					if (ctrList.isEmpty() == false) {
						...
						if (m == 1 && n == 0)
							InsertOptimisedParametersData.OSCTRoptimisation(
									campId, "DBM", parameterP1Map
											+ parameterP2Map);
						...
						if (m == 2 && n == 0) {
							...
							InsertOptimisedParametersData
									.SegmentCTRoptimisation(campId, "DBM",
						...
						if (m == 2 && n == 1)
							InsertOptimisedParametersData
									.SegmentCTRoptimisation(campId, "Adwords",
											parameterP1Map + parameterP2Map);

						if (m == 2 && n == 2)
							InsertOptimisedParametersData
									.SegmentCTRoptimisation(campId, "Facebook",
											parameterP1Map + parameterP2Map);

						if (m == 3 && n == 0)
							InsertOptimisedParametersData.AgeCTRoptimisation(
									campId, "DBM", parameterP1Map
											+ parameterP2Map);
						...
						if (m == 4 && n == 0)
							InsertOptimisedParametersData
									.GenderCTRoptimisation(campId, "DBM",
											parameterP1Map + parameterP2Map);

						if (m == 4 && n == 1)
							InsertOptimisedParametersData
									.GenderCTRoptimisation(campId, "Adwords",
											parameterP1Map + parameterP2Map);

						if (m == 4 && n == 2)
							InsertOptimisedParametersData
									.GenderCTRoptimisation(campId, "Facebook",
											parameterP1Map + parameterP2Map);
